...
analysis_notebooks_dir="/my_scripts/TF-Atlas/anvil/analysis/"

mkdir /project
project_dir=/project

# create the log file
logfile=$project_dir/${1}_analysis.log
touch $logfile

# create the report directories
analysis_output_dir=$project_dir/analysis
echo $( timestamp ): "mkdir" $analysis_output_dir | tee -a $logfile
...
# 		jupyter nbconvert \
#         --execute $analysis_notebooks_dir/showcase_motifs_and_profiles.ipynb \
#         --to HTML --output $analysis_output_dir/${key}_seqlet_profile_examples \
#         --ExecutePreprocessor.timeout=-1 &
# done
...
# 		jupyter nbconvert \
#         --execute $analysis_notebooks_dir/summarize_motif_hits.ipynb --to HTML \
#         --output $analysis_output_dir/${key}_motif_hits \
#         --ExecutePreprocessor.timeout=-1 &
# done
# wait
...
# for key in profile counts
# do
#     # cache directory for cluster motifs analysis notebook
#     cluster_cache_dir=$analysis_output_dir/cluster_cache_$key
...
# 		jupyter nbconvert \
#         --execute $analysis_notebooks_dir/cluster_motif_hits_and_peaks.ipynb \
#         --to HTML --output $analysis_output_dir/${key}_motif_peak_clustering \
#         --ExecutePreprocessor.timeout=-1 &
# done
# wait
